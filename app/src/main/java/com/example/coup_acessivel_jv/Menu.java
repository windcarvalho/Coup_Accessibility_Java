...
public class Menu extends AppCompatActivity {
    ...
    public void mToasts(final int messageInt){
        Log.v(TAG,"tentou mostrar um Toast");
   ...
   /* private void checkPermissionNFC(){
        ...
        if (ActivityCompat.checkSelfPermission(this,NFC_SERVICE) != PackageManager.PERMISSION_GRANTED){
            Log.i(TAG,"Não tem permissão de NFC!");
            ...
            Log.i(TAG,"Já tem permissão de NFC!");
        }
    }*/
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(intent.getAction())) {
             Log.i(TAG,"Descoberta de Tag");
        }else{
            Log.i(TAG,"Descoberta de Tag:"+intent.getAction());
        }
